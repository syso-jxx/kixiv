...
<body>
				...
				<table class="table table-sm">
					<tbody>
						<tr>
							...
							<td scope="col" style="padding:1px 15px;"><input type="text" name="notice_title" id="title" style="width: 100%;" value="${notice.notice_title}"/></td>
						</tr>
						<tr>
	...
	$('.summernote').summernote('code', '${notice.notice_content}');
