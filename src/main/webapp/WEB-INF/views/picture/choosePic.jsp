...
<body>
	...
	<div class="site-section" data-aos="fade">
		<div class="container-fluid">
			...
			<div class="row col-12 ">
				<div class="col-sm-2 offset-sm-4" style="text-align:center;">
					user_id : ${user.user_id}
					profile_img : ${user.profile_img}
					<button class="btn_menu" style="background-image: url(imgProfileUpload/1624602475299sana.gif);" onclick="profile_img()"></button>
				</div>
				<div class="col-sm-3";">
					<div style="padding-left:30px;">
						<h2>kjw</h2>
						<h4>kjw123@naver.com</h4>
						<h4>좋아요 : 1,123,937</h4>
						<button class="flower">팔로우</button>							
					</div>
				</div>
			</div>
			<div>
			...
			<div class="row" id="lightgallery">
				<div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 item"
					data-aos="fade"
					data-src="assets_img/images/big-assets_img/images/nature_big_1.jpg"
					...
					<a href="#"><img src="assets_img/images/nature_small_1.jpg"
						alt="IMage" class="img-fluid"></a>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 item"
					data-aos="fade"
					data-src="assets_img/images/big-assets_img/images/nature_big_2.jpg"
					...
					<a href="#"><img src="assets_img/images/nature_small_2.jpg"
						alt="IMage" class="img-fluid"></a>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 item"
					data-aos="fade"
					data-src="assets_img/images/big-assets_img/images/nature_big_3.jpg"
					...
					<a href="#"><img src="assets_img/images/nature_small_3.jpg"
						alt="IMage" class="img-fluid"></a>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 item"
					data-aos="fade"
					data-src="assets_img/images/big-assets_img/images/nature_big_4.jpg"
					...
					<a href="#"><img src="assets_img/images/nature_small_4.jpg"
						alt="IMage" class="img-fluid"></a>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 item"
					data-aos="fade"
					data-src="assets_img/images/big-assets_img/images/nature_big_5.jpg"
					...
					<a href="#"><img src="assets_img/images/nature_small_5.jpg"
						alt="IMage" class="img-fluid"></a>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 item"
					data-aos="fade"
					data-src="assets_img/images/big-assets_img/images/nature_big_6.jpg"
					...
					<a href="#"><img src="assets_img/images/nature_small_6.jpg"
						alt="IMage" class="img-fluid"></a>
				</div>

				<div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 item"
					data-aos="fade"
					data-src="assets_img/images/big-assets_img/images/nature_big_7.jpg"
					...
					<a href="#"><img src="assets_img/images/nature_small_7.jpg"
						alt="IMage" class="img-fluid"></a>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 item"
					data-aos="fade"
					data-src="assets_img/images/big-assets_img/images/nature_big_8.jpg"
					...
					<a href="#"><img src="assets_img/images/nature_small_8.jpg"
						alt="IMage" class="img-fluid"></a>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 item"
					data-aos="fade"
					data-src="assets_img/images/big-assets_img/images/nature_big_9.jpg"
					...
					<a href="#"><img src="assets_img/images/nature_small_9.jpg"
						alt="IMage" class="img-fluid"></a>
				</div>
	...
	<script>
		function profile_img(){
			window.open("profileFileUpload", "profile edit", "width=500, height=400,toolbar=yes, scrollbars=yes,resizable=yes, top=500,left=500");
		}
