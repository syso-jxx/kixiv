		            ...
		            if (returnData.startNum<=returnData.totCnt){
		                if(data.length>0){
		                	for(const i in data){
		                		...
		                		html += "		<img src = '" + pic_path + "' alt='IMage' class='img-fluid' style='100%; height: 326px; margin-bottom: 20px;'>";
		                		html += "	</a>";
		                		html += "</div>";
...
<%= request.getContextPath() %>
				<div class="col-md-7">
					<div class="row mb-5">
						<div class="col-12 ">
							<h2 class="site-section-heading text-center" style="color: black; margin-bottom: 30px;">추천 이미지</h2>	
							...
							<select name="job" style="float: right;" id="selectImg">
							    ...
							    <option value="추천사진순" selected>추천사진</option>
							</select>
						</div>
					</div>
				</div>
