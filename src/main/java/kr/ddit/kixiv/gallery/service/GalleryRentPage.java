...
public class GalleryRentPage {
	...
	public GalleryRentPage(int total, int currentPage, int size, List<Map<String, Object>> content) {
		this.total = total;
	...
	public String toString() {
		return "GalleryRentPage [total=" + total + ", currentPage=" + currentPage + ", content=" + content
