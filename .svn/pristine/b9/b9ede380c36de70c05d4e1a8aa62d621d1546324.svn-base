	...
	<div class="container">
		<div class="input-form-background row">
			<div class="input-form col-md-12 mx-auto">
				<h4 class="mb-3">갤러리 추가</h4>
				<form id="frm" name="frm" method="post" enctype="multipart/form-data">
					<input type="file" name="file" style="display:none"/>
				</form>
				
				<form name="form" id="form" class="validation-form" action="/addGallery" method="post" autocomplete="off">
					<div class="row">
						<div class="col-md-6 mt-3">
							<div class="row mb-2">
								<div class="col-md-12">
									<label for="gallery_name">갤러리명</label> 
									<input type="text" name="gallery_name" class="form-control" id="gallery_name" value="이응노 미술관 옆" placeholder="" required>
								</div>
							</div>
							<div>
							...
							<div class="row mb-2">
								<div class="col-md-12">
									...
									<input type="text" class="form-control" name="gallery_tel" id="gallery_tel"	value="02-123-1234" placeholder="ex) 02-123-1234 or 010-1234-1234" required>
								</div>
							</div>
							<div>
						...
						<div class="col-md-6" style="width:300px;height:200px; overflow: hidden;">
							<img src="imgGalleryUpload/noimg.gif" alt="이미지 없음" id="gallery_img" style="height:200px;" >
							<input type="hidden" name="gallery_img" value="imgGalleryUpload/noimg.gif">						
					...
					<div class="row mb-2">
						<div class="col-md-12">
							...
							<textarea type="text" name="gallery_intro" class="form-control" id="gallery_intro" rows="5" cols="33" required>놀러오세요</textarea>
						</div>
					</div>
					<div>
					...
					<div class="mb-3">
						<div>
							...
							<input type="text" class="form-control" name="homepage" id="homepage" placeholder="" value="abc" required>
						</div>
						<div>
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							...
							<input type="text" class="form-control" name="gallery_zip" id="gallery_zip" placeholder="주소 검색" readonly>
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							<div>
								...
								<input type="text" class="form-control" name="gallery_add1" id="gallery_add1" readonly>
						...
						<div class="col-md-6 mb-3">
							...
							<input type="text" class="form-control" name="gallery_add2" id="gallery_add2" placeholder="상세주소를 입력해주세요.">
						</div>
					</div>
					<button type="button" class="btn btn-primary btn-lg btn-block" onclick="submitCheck()">갤러리 추가</button>
				</form>
			</div>
		</div>
	</div>
