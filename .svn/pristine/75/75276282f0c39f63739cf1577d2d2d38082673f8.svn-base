...
<%= request.getContextPath() %>
				<div class="col-md-7">
					<div class="row mb-5">
						<div class="col-12 ">
							<h2 class="site-section-heading text-center" style="color: black; margin-bottom: 30px;">구독 작가 이미지</h2>	
							...
							<select name="job" style="float: right;" id="selectImg">
							    ...
							    <option value="구독작가순" selected>구독작가순</option>
